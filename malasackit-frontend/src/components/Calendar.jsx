...
export default function CalendarComponent() {
    ...
    return (
        <div className="space-y-6">
            ...
            <style jsx>{`
                .calendar-container :global(.react-calendar-custom) {
                    width: 100%;
                    border: none;
                    font-family: inherit;
                }
                ...
                .calendar-container :global(.react-calendar__month-view__days__day--active) {
                ...
                .calendar-container :global(.has-events) {
                    background-color: #fef2f2;
                    border: 1px solid #fecaca;
                }
                
                .calendar-container :global(.has-events:hover) {
